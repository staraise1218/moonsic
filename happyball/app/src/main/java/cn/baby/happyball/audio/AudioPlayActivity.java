...
import cn.baby.happyball.vedio.VedioStudyActivity;

public class AudioPlayActivity extends BaseActivity implements View.OnFocusChangeListener {
...
//            mMediaPlayer.setWakeMode(getApplicationContext(), PowerManager.PARTIAL_WAKE_LOCK);
            ...
            showLoading(false);
            Toast.makeText(AudioPlayActivity.this, "音频加载失败", Toast.LENGTH_SHORT).show();
        }
